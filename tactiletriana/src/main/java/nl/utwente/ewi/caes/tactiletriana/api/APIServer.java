...
public class APIServer implements Runnable {
    ...
    /**
     * Synchronized method for adding a ServerConnection to the list of active
     * connections.
     *
     * @param s
     */
    ...
    /**
     * Synchronized method for removing a ServerConnection from the list of
     * active ServerConnections
     *
     * @param s
     */
    ...
    /**
     * Get the active server connections TODO make the returned list immutable
     *
    ...
    /**
     * Unregisters a ServerConnection as the controller. Only works if the given
     * ServerConnection actually was the controller.
     *
     * @param s ServerConnection that is the current controller of the
     * simulation
     */
