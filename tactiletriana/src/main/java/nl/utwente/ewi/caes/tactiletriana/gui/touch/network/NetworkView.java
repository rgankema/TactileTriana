...
public class NetworkView extends Pane {
    ...
    @FXML
    private TransformerView t;

    @FXML
    private HouseView h1;
    @FXML
    private HouseView h2;
    @FXML
    private HouseView h3;
    @FXML
    private HouseView h4;
    @FXML
    private HouseView h5;
    @FXML
    private HouseView h6;

    @FXML
    private NodeView ni1;
    @FXML
    private NodeView ni2;
    @FXML
    private NodeView ni3;
    @FXML
    private NodeView ni4;
    @FXML
    private NodeView ni5;
    @FXML
    private NodeView ni6;

    @FXML
    private NodeView nh1;
    @FXML
    private NodeView nh2;
    @FXML
    private NodeView nh3;
    @FXML
    private NodeView nh4;
    @FXML
    private NodeView nh5;
    @FXML
    private NodeView nh6;

    @FXML
    private CableView t_ni1;
    @FXML
    private CableView ni1_ni2;
    @FXML
    private CableView ni2_ni3;
    @FXML
    private CableView ni3_ni4;
    @FXML
    private CableView ni4_ni5;
    @FXML
    private CableView ni5_ni6;

    @FXML
    private CableView ni1_nh1;
    @FXML
    private CableView ni2_nh2;
    @FXML
    private CableView ni3_nh3;
    @FXML
    private CableView ni4_nh4;
    @FXML
    private CableView ni5_nh5;
    @FXML
    private CableView ni6_nh6;
